...
public class DomainRing_Task_4_1 extends BaseExerciseTest {
    ...
    @Test
    @DisplayName("A valid equipment code is created")
    void valid_equipment_code_is_created() {
        assertThat(new EquipmentCode("GS200").value()).isEqualTo("GS200");
    }

    @Test
    @DisplayName("Equipment code is not valid due to null value")
    void equipment_code_is_invalid_due_to_null_value() {
        assertThrows(Exception.class, () -> new EquipmentCode(null));
    }

    @Test
    @DisplayName("Equipment code is not valid due to worng value")
    void equipment_code_is_invalid_due_to_wrong_value() {
