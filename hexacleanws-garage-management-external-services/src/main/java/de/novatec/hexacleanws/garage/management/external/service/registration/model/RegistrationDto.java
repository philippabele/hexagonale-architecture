 ...
 */
@JsonPropertyOrder({
        RegistrationDto.JSON_PROPERTY_CIAM_ACCOUNT_CREATED,
        RegistrationDto.JSON_PROPERTY_CIAM_ID,
        RegistrationDto.JSON_PROPERTY_USER_ID,
        RegistrationDto.JSON_PROPERTY_CREATED_AT,
        RegistrationDto.JSON_PROPERTY_CREATED_BY,
        RegistrationDto.JSON_PROPERTY_IS_EMAIL_CIAM_VERIFIED,
        RegistrationDto.JSON_PROPERTY_IS_MOBILE_CIAM_VERIFIED,
        RegistrationDto.JSON_PROPERTY_ACCOUNT_VERIFIED,
        RegistrationDto.JSON_PROPERTY_ACCOUNT_IDENTIFIER,
        RegistrationDto.JSON_PROPERTY_UPDATED_AT,
        RegistrationDto.JSON_PROPERTY_IDENTIFICATION_TYPE,
        RegistrationDto.JSON_PROPERTY_CASE_NUMBER,
        RegistrationDto.JSON_PROPERTY_FIRST_NAME,
        RegistrationDto.JSON_PROPERTY_LAST_NAME1,
        RegistrationDto.JSON_PROPERTY_LAST_NAME2,
        RegistrationDto.JSON_PROPERTY_TITLE,
        RegistrationDto.JSON_PROPERTY_NAME_PREFIX,
        RegistrationDto.JSON_PROPERTY_MIDDLE_INITIAL,
        RegistrationDto.JSON_PROPERTY_SALUTATION_CODE,
        RegistrationDto.JSON_PROPERTY_EMAIL,
        RegistrationDto.JSON_PROPERTY_LANDLINE_PHONE,
        RegistrationDto.JSON_PROPERTY_MOBILE_PHONE_NUMBER,
        RegistrationDto.JSON_PROPERTY_BIRTHDAY,
        RegistrationDto.JSON_PROPERTY_PREFERRED_LANGUAGE_CODE,
        RegistrationDto.JSON_PROPERTY_ACCOUNT_COUNTRY_CODE,
        RegistrationDto.JSON_PROPERTY_ADDRESS,
        RegistrationDto.JSON_PROPERTY_COMMUNICATION_PREFERENCES,
        RegistrationDto.JSON_PROPERTY_VIP,
        RegistrationDto.JSON_PROPERTY_IDENTIFICATION_NUMBER,
        RegistrationDto.JSON_PROPERTY_TAX_NUMBER
})
...
public class RegistrationDto {
    public static final String JSON_PROPERTY_CIAM_ACCOUNT_CREATED = "ciamAccountCreated";
    private Boolean ciamAccountCreated;
    ...
    public RegistrationDto ciamAccountCreated(Boolean ciamAccountCreated) {

        this.ciamAccountCreated = ciamAccountCreated;
        return this;
    }

    /**
     * Get ciamAccountCreated
     *
     * @return ciamAccountCreated
     **/
    @javax.annotation.Nonnull
    @ApiModelProperty(required = true, value = "")
    @JsonProperty(JSON_PROPERTY_CIAM_ACCOUNT_CREATED)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)

    public Boolean getCiamAccountCreated() {
        return ciamAccountCreated;
    }
    ...
    @JsonProperty(JSON_PROPERTY_CIAM_ACCOUNT_CREATED)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setCiamAccountCreated(Boolean ciamAccountCreated) {
        this.ciamAccountCreated = ciamAccountCreated;
    }


    public RegistrationDto ciamId(String ciamId) {
    ...
    public RegistrationDto userId(String userId) {
    ...
    public RegistrationDto createdAt(DateTime createdAt) {
    ...
    public RegistrationDto createdBy(String createdBy) {
    ...
    public RegistrationDto isEmailCiamVerified(Boolean isEmailCiamVerified) {
    ...
    public RegistrationDto isMobileCiamVerified(Boolean isMobileCiamVerified) {
    ...
    public RegistrationDto accountVerified(Boolean accountVerified) {
    ...
    public RegistrationDto accountIdentifier(String accountIdentifier) {
    ...
    public RegistrationDto updatedAt(DateTime updatedAt) {
    ...
    public RegistrationDto identificationType(String identificationType) {
    ...
    public RegistrationDto caseNumber(String caseNumber) {
    ...
    public RegistrationDto firstName(String firstName) {
    ...
    public RegistrationDto lastName1(String lastName1) {
    ...
    public RegistrationDto lastName2(String lastName2) {
    ...
    public RegistrationDto title(String title) {
    ...
    public RegistrationDto namePrefix(String namePrefix) {
    ...
    public RegistrationDto middleInitial(String middleInitial) {
    ...
    public RegistrationDto salutationCode(String salutationCode) {
    ...
    public RegistrationDto landlinePhone(String landlinePhone) {
    ...
    public RegistrationDto mobilePhoneNumber(String mobilePhoneNumber) {
    ...
    public RegistrationDto birthday(LocalDate birthday) {
    ...
    public RegistrationDto preferredLanguageCode(String preferredLanguageCode) {
    ...
    public RegistrationDto accountCountryCode(String accountCountryCode) {
    ...
    public RegistrationDto address(UserAddress address) {
    ...
    public RegistrationDto communicationPreferences(UserCommunicationPreferences communicationPreferences) {
    ...
    public RegistrationDto vip(Boolean vip) {
    ...
    public RegistrationDto identificationNumber(String identificationNumber) {
    ...
    public RegistrationDto taxNumber(String taxNumber) {
    ...
    public boolean equals(Object o) {
        ...
        RegistrationDto newUserResponseBody = (RegistrationDto) o;
        return Objects.equals(this.ciamAccountCreated, newUserResponseBody.ciamAccountCreated) &&
                Objects.equals(this.ciamId, newUserResponseBody.ciamId) &&
                Objects.equals(this.userId, newUserResponseBody.userId) &&
                Objects.equals(this.createdAt, newUserResponseBody.createdAt) &&
                Objects.equals(this.createdBy, newUserResponseBody.createdBy) &&
                Objects.equals(this.isEmailCiamVerified, newUserResponseBody.isEmailCiamVerified) &&
                Objects.equals(this.isMobileCiamVerified, newUserResponseBody.isMobileCiamVerified) &&
                Objects.equals(this.accountVerified, newUserResponseBody.accountVerified) &&
                Objects.equals(this.accountIdentifier, newUserResponseBody.accountIdentifier) &&
                Objects.equals(this.updatedAt, newUserResponseBody.updatedAt) &&
                Objects.equals(this.identificationType, newUserResponseBody.identificationType) &&
                Objects.equals(this.caseNumber, newUserResponseBody.caseNumber) &&
                Objects.equals(this.firstName, newUserResponseBody.firstName) &&
                Objects.equals(this.lastName1, newUserResponseBody.lastName1) &&
                Objects.equals(this.lastName2, newUserResponseBody.lastName2) &&
                Objects.equals(this.title, newUserResponseBody.title) &&
                Objects.equals(this.namePrefix, newUserResponseBody.namePrefix) &&
                Objects.equals(this.middleInitial, newUserResponseBody.middleInitial) &&
                Objects.equals(this.salutationCode, newUserResponseBody.salutationCode) &&
                Objects.equals(this.email, newUserResponseBody.email) &&
                Objects.equals(this.landlinePhone, newUserResponseBody.landlinePhone) &&
                Objects.equals(this.mobilePhoneNumber, newUserResponseBody.mobilePhoneNumber) &&
                Objects.equals(this.birthday, newUserResponseBody.birthday) &&
                Objects.equals(this.preferredLanguageCode, newUserResponseBody.preferredLanguageCode) &&
                Objects.equals(this.accountCountryCode, newUserResponseBody.accountCountryCode) &&
                Objects.equals(this.address, newUserResponseBody.address) &&
                Objects.equals(this.communicationPreferences, newUserResponseBody.communicationPreferences) &&
                Objects.equals(this.vip, newUserResponseBody.vip) &&
                Objects.equals(this.identificationNumber, newUserResponseBody.identificationNumber) &&
                Objects.equals(this.taxNumber, newUserResponseBody.taxNumber);
    }

    @Override
    public int hashCode() {
        return Objects.hash(ciamAccountCreated, ciamId, userId, createdAt, createdBy, isEmailCiamVerified, isMobileCiamVerified, accountVerified, accountIdentifier, updatedAt, identificationType, caseNumber, firstName, lastName1, lastName2, title, namePrefix, middleInitial, salutationCode, email, landlinePhone, mobilePhoneNumber, birthday, preferredLanguageCode, accountCountryCode, address, communicationPreferences, vip, identificationNumber, taxNumber);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class NewUserResponseBody {\n");
        sb.append("    ciamAccountCreated: ").append(toIndentedString(ciamAccountCreated)).append("\n");
