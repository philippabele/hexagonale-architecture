 ...
 */
@JsonPropertyOrder({
        CpdUserApiV2Enums.JSON_PROPERTY_ACCOUNT_IDENTIFIER
})
...
public class CpdUserApiV2Enums {
    /**
     * Gets or Sets accountIdentifier
     */
    public enum AccountIdentifierEnum {
        EMAIL("EMAIL"),
        ...
        AccountIdentifierEnum(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static AccountIdentifierEnum fromValue(String value) {
            for (AccountIdentifierEnum b : AccountIdentifierEnum.values()) {
    ...
    private AccountIdentifierEnum accountIdentifier;

    public CpdUserApiV2Enums() {
    }

    public CpdUserApiV2Enums accountIdentifier(AccountIdentifierEnum accountIdentifier) {
    ...
    public AccountIdentifierEnum getAccountIdentifier() {
        return accountIdentifier;
    }
    ...
    @JsonProperty(JSON_PROPERTY_ACCOUNT_IDENTIFIER)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setAccountIdentifier(AccountIdentifierEnum accountIdentifier) {
        this.accountIdentifier = accountIdentifier;
    }
    ...
    public boolean equals(Object o) {
        ...
        CpdUserApiV2Enums cpdUserApiV2Enums = (CpdUserApiV2Enums) o;
        return Objects.equals(this.accountIdentifier, cpdUserApiV2Enums.accountIdentifier);
    }
    ...
    public String toString() {
        ...
        sb.append("class CpdUserApiV2Enums {\n");
