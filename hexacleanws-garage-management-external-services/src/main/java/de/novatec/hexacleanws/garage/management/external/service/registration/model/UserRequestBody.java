 ...
 */
@JsonPropertyOrder({
        UserRequestBody.JSON_PROPERTY_ACCOUNT_IDENTIFIER,
        UserRequestBody.JSON_PROPERTY_ACCOUNT_VERIFIED,
        UserRequestBody.JSON_PROPERTY_FIRST_NAME,
        UserRequestBody.JSON_PROPERTY_LAST_NAME1,
        UserRequestBody.JSON_PROPERTY_LAST_NAME2,
        UserRequestBody.JSON_PROPERTY_TITLE,
        UserRequestBody.JSON_PROPERTY_NAME_PREFIX,
        UserRequestBody.JSON_PROPERTY_MIDDLE_INITIAL,
        UserRequestBody.JSON_PROPERTY_SALUTATION_CODE,
        UserRequestBody.JSON_PROPERTY_EMAIL,
        UserRequestBody.JSON_PROPERTY_LANDLINE_PHONE,
        UserRequestBody.JSON_PROPERTY_MOBILE_PHONE_NUMBER,
        UserRequestBody.JSON_PROPERTY_BIRTHDAY,
        UserRequestBody.JSON_PROPERTY_PREFERRED_LANGUAGE_CODE,
        UserRequestBody.JSON_PROPERTY_ACCOUNT_COUNTRY_CODE,
        UserRequestBody.JSON_PROPERTY_ADDRESS,
        UserRequestBody.JSON_PROPERTY_COMMUNICATION_PREFERENCES,
        UserRequestBody.JSON_PROPERTY_VIP,
        UserRequestBody.JSON_PROPERTY_IDENTIFICATION_NUMBER,
        UserRequestBody.JSON_PROPERTY_TAX_NUMBER
})
...
public class UserRequestBody {
    ...
    public UserRequestBody accountIdentifier(String accountIdentifier) {
    ...
    public UserRequestBody accountVerified(Boolean accountVerified) {
    ...
    public UserRequestBody lastName1(String lastName1) {
    ...
    public UserRequestBody lastName2(String lastName2) {
    ...
    public UserRequestBody title(String title) {
    ...
    public UserRequestBody namePrefix(String namePrefix) {
    ...
    public UserRequestBody middleInitial(String middleInitial) {
    ...
    public UserRequestBody salutationCode(String salutationCode) {
    ...
    public UserRequestBody landlinePhone(String landlinePhone) {
    ...
    public UserRequestBody mobilePhoneNumber(String mobilePhoneNumber) {
    ...
    public UserRequestBody birthday(LocalDate birthday) {
    ...
    public UserRequestBody preferredLanguageCode(String preferredLanguageCode) {
    ...
    public UserRequestBody accountCountryCode(String accountCountryCode) {
    ...
    public UserRequestBody address(UserAddress address) {
    ...
    public UserRequestBody communicationPreferences(UserCommunicationPreferences communicationPreferences) {
    ...
    public UserRequestBody vip(Boolean vip) {
    ...
    public UserRequestBody identificationNumber(String identificationNumber) {
    ...
    public UserRequestBody taxNumber(String taxNumber) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.accountIdentifier, userRequestBody.accountIdentifier) &&
                Objects.equals(this.accountVerified, userRequestBody.accountVerified) &&
                Objects.equals(this.firstName, userRequestBody.firstName) &&
                Objects.equals(this.lastName1, userRequestBody.lastName1) &&
                Objects.equals(this.lastName2, userRequestBody.lastName2) &&
                Objects.equals(this.title, userRequestBody.title) &&
                Objects.equals(this.namePrefix, userRequestBody.namePrefix) &&
                Objects.equals(this.middleInitial, userRequestBody.middleInitial) &&
                Objects.equals(this.salutationCode, userRequestBody.salutationCode) &&
                Objects.equals(this.email, userRequestBody.email) &&
                Objects.equals(this.landlinePhone, userRequestBody.landlinePhone) &&
                Objects.equals(this.mobilePhoneNumber, userRequestBody.mobilePhoneNumber) &&
                Objects.equals(this.birthday, userRequestBody.birthday) &&
                Objects.equals(this.preferredLanguageCode, userRequestBody.preferredLanguageCode) &&
                Objects.equals(this.accountCountryCode, userRequestBody.accountCountryCode) &&
                Objects.equals(this.address, userRequestBody.address) &&
                Objects.equals(this.communicationPreferences, userRequestBody.communicationPreferences) &&
                Objects.equals(this.vip, userRequestBody.vip) &&
                Objects.equals(this.identificationNumber, userRequestBody.identificationNumber) &&
                Objects.equals(this.taxNumber, userRequestBody.taxNumber);
    }

    @Override
    public int hashCode() {
        return Objects.hash(accountIdentifier, accountVerified, firstName, lastName1, lastName2, title, namePrefix, middleInitial, salutationCode, email, landlinePhone, mobilePhoneNumber, birthday, preferredLanguageCode, accountCountryCode, address, communicationPreferences, vip, identificationNumber, taxNumber);
    }
