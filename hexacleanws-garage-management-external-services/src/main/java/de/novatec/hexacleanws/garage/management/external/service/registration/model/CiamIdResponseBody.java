 ...
 */
@JsonPropertyOrder({
        CiamIdResponseBody.JSON_PROPERTY_CIAM_ID
})
...
public class CiamIdResponseBody {
    public static final String JSON_PROPERTY_CIAM_ID = "ciamId";
    private String ciamId;

    public CiamIdResponseBody() {
    }

    public CiamIdResponseBody ciamId(String ciamId) {
    ...
    public boolean equals(Object o) {
        ...
        CiamIdResponseBody ciamIdResponseBody = (CiamIdResponseBody) o;
        return Objects.equals(this.ciamId, ciamIdResponseBody.ciamId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(ciamId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CiamIdResponseBody {\n");
